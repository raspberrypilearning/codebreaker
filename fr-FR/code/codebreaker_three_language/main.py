...
def menu():
    ...
    while choice != 'c' and choice != 'f' and choice != 'm':  # Keep asking the user for the right answer
        choice = input(
            'Please enter c to encode/decode a text file, f to perform frequency analysis in three languages, or m to enter your own message to encode:')
    ...
    if choice == 'c':
        ...
        # print(message_freq)
        language = input(
            'Which language is your message in? \n1. English \n2. French \n3. Spanish')
